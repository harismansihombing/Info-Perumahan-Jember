            ...
            <div class="col-md-10">
                <div class="card text-white">
                    ...
                    <div class="card-body text-dark">
                        <form action="cari_rumah.php" method="POST">
                            <?php
    ...
    <section class="hotel-rooms spad">
        <div class="container">
            <div class="row">
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM tabel_data_rumah ORDER BY RAND() LIMIT 12") or die("Invalid Query !!!");
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-side">
                        ...
                        <p>Info Perumahan Jember Merupakan Situs yang Menyediakan Informasi Rumah bagi yang ingin
                            mencari rumah
